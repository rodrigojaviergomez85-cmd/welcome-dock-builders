...
export const LINES: Line[] = [
  ...
  { id: "luna-cheer-wonderful", speaker: "luna", text: "Wonderful!" },
  { id: "luna-cheer-super", speaker: "luna", text: "Super!" },
  { id: "luna-cheer-you-did-it", speaker: "luna", text: "You did it!" },
  { id: "luna-cheer-almost", speaker: "luna", text: "Almost! One more time!" },
  { id: "leo-cheer-fantastic", speaker: "leo", text: "Fantastic!" },
  { id: "leo-cheer-awesome", speaker: "leo", text: "Awesome!" },
  { id: "leo-cheer-great-job", speaker: "leo", text: "Great job!" },
  { id: "leo-cheer-wonderful", speaker: "leo", text: "Wonderful!" },
  { id: "leo-cheer-super", speaker: "leo", text: "Super!" },
  { id: "leo-cheer-you-did-it", speaker: "leo", text: "You did it!" },
  { id: "leo-cheer-almost", speaker: "leo", text: "Almost! One more time!" },
  { id: "boti-cheer-fantastic", speaker: "boti", text: "Fantastic!" },
  { id: "boti-cheer-awesome", speaker: "boti", text: "Awesome!" },
  { id: "boti-cheer-great-job", speaker: "boti", text: "Great job!" },
  { id: "boti-cheer-wonderful", speaker: "boti", text: "Wonderful!" },
  { id: "boti-cheer-super", speaker: "boti", text: "Super!" },
  { id: "boti-cheer-you-did-it", speaker: "boti", text: "You did it!" },
  { id: "boti-cheer-almost", speaker: "boti", text: "Almost! One more time!" },
  { id: "mia-cheer-fantastic", speaker: "mia", text: "Fantastic!" },
  { id: "mia-cheer-awesome", speaker: "mia", text: "Awesome!" },
  { id: "mia-cheer-great-job", speaker: "mia", text: "Great job!" },
  { id: "mia-cheer-wonderful", speaker: "mia", text: "Wonderful!" },
  { id: "mia-cheer-super", speaker: "mia", text: "Super!" },
  { id: "mia-cheer-you-did-it", speaker: "mia", text: "You did it!" },
  { id: "mia-cheer-almost", speaker: "mia", text: "Almost! One more time!" },
];
